...
export default function LecturerHome({ user }) {
  ...
  const handleAdd = () => {
    const newAnnouncement = {
      ...
      title: "New Announcement Title Here",
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm">
        <div className="flex justify-between items-center p-6 border-b dark:border-gray-700">
          ...
          <div className="flex gap-10">
            <button className="text-black dark:text-white hover:text-gray-500 dark:hover:text-zinc-300">
              View All
            </button>
            <button
              className="text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300"
              onClick={() => handleEdit(1)} // Example: Edit the first announcement
            >
              Edit
            </button>
            <button
